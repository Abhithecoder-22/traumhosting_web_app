...
const HeroSection = () => {
  return (
    // <main classNameName="pt-16">
    //   {/* Hero Section */}
    //   <section classNameName="relative bg-gradient-to-br from-blue-900 to-indigo-800 text-white overflow-hidden">
    //     <div classNameName="absolute inset-0 bg-black opacity-50"></div>
    //     <div
    //       classNameName="absolute inset-0 bg-cover bg-center"
    //       style={{
    ...
    //     <div classNameName="container mx-auto px-4 py-24 md:py-32 relative z-10">
    //       <div classNameName="flex flex-col md:flex-row items-center justify-between">
    //         {/* Left Side: Company Info */}
    //         <div classNameName="w-full md:w-1/2 mb-12 md:mb-0">
    //           <h1 classNameName="text-5xl md:text-6xl font-bold mb-6 leading-tight">
    //             Innovate.<br />Transform.<br />Succeed.
    //           </h1>
    //           <p classNameName="text-xl mb-8 text-gray-300">
    //             Empowering businesses with cutting-edge solutions for a digital future.
    //           </p>
    //           <div classNameName="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
    //             <a
    //               href="#"
    //               classNameName="bg-white text-blue-900 font-semibold px-8 py-3 rounded-full hover:bg-blue-100 transition duration-300 text-center"
    //             >
    //               Get Started
    //             </a>
    //             <a
    //               href="#"
    //               classNameName="border-2 border-white text-white font-semibold px-8 py-3 rounded-full hover:bg-white hover:text-blue-900 transition duration-300 text-center"
    //             >
    //               Learn More
    //             </a>
    //           </div>
    ...
    //         {/* Right Side: Features */}
    //         <div classNameName="w-full md:w-1/2 md:pl-12">
    //           {/* <div classNameName="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-xl p-8 shadow-2xl"> */}
    //           <div classNameName="backdrop-blur-sm bg-white/30  w-96 rounded-xl bg-white/20 shadow-2xl ring-1 ring-black/5 p-8">

    //             <h2 classNameName="text-2xl font-semibold mb-6">Why MyCompany?</h2>
    //             <ul classNameName="space-y-4">
    //               <li classNameName="flex items-center">
    //                 <svg
    //                   classNameName="w-6 h-6 mr-3 text-yellow-400"
    //                   fill="none"
    //                   stroke="currentColor"
    //                   viewBox="0 0 24 24"
    ...
    //               <li classNameName="flex items-center">
    //                 <svg
    //                   classNameName="w-6 h-6 mr-3 text-green-400"
    //                   fill="none"
    //                   stroke="currentColor"
    //                   viewBox="0 0 24 24"
    //                   xmlns="http://www.w3.org/2000/svg"
    ...
    //               <li classNameName="flex items-center">
    //                 <svg
    //                   classNameName="w-6 h-6 mr-3 text-purple-400"
    //                   fill="none"
    //                   stroke="currentColor"
    //                   viewBox="0 0 24 24"
    //                   xmlns="http://www.w3.org/2000/svg"
    ...
    //     {/* Decorative Element */}
    //     <div classNameName="absolute bottom-0 left-0 right-0">
    //       <svg
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="w-full flex flex-col lg:flex-row">
        <div className="flex justify-between lg:flex-row">
          <a href="
          https://pagedone.io/" className="flex items-center">
        ...
        <div className="hidden w-full lg:flex lg:pl-11 max-lg:mt-1 max-lg:h-screen max-lg:overflow-y-auto" id="navbar">
          <ul
            className="flex lg:items-center lg:justify-center flex-col max-lg:gap-4 max-lg:pt-4 max-lg:mb-4 lg:mt-0 lg:flex-row lg:mx-auto ">
            <li>
              <a href="javascript:;"
                className="nav-link mb-2 block lg:mr-6 md:mb-0 lg:text-left text-base text-gray-500 font-medium transition-all duration-500 hover:text-gray-900">Home</a>
            </li>
            <li>
              <a href="javascript:;"
            ...
            <li className="relative">
              ...
              <div id="menu1" aria-labelledby="menu1"
                ...
                <div className="flex flex-col md:flex-row justify-between">
                  <ul className="text-sm text-gray-700 md:w-1/2" aria-labelledby="dropdownLargeButton">
                  ...
                  <ul className="text-sm text-gray-700 dark:text-gray-400 md:w-1/2" aria-labelledby="dropdownLargeButton">
                    <h6 className="font-medium text-sm text-gray-500 mb-2">
                      Services
                    </h6>
                    <li className="">
          ...
          <div
            className="flex lg:items-center w-full justify-start flex-col lg:flex-row gap-4 lg:w-max max-lg:gap-4 lg:ml-14 lg:justify-end">
            <button
    ...
    <div className="w-full max-w-7xl mx-auto px-4 lg:px-8">
      <div className="w-full max-w-4xl mx-auto sm:px-12 mb-10 lg:mb-20">
        ...
        <div className="parent flex flex-col sm:flex-row items-center max-w-xl mx-auto justify-center gap-y-4 sm:justify-between pr-2 sm:pr-1 sm:bg-white rounded-full mb-5 relative group transition-all duration-500 border border-transparent hover:border-indigo-600 focus-within:border-indigo-600">
          <input type="email" className="block w-full px-6 py-3.5 text-base max-sm:text-center font-normal shadow-xs max-sm:bg-white text-gray-900 bg-transparent border-none rounded-full placeholder-gray-400 focus:outline-none leading-normal" placeholder="What’s your work email?" />
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-4 lg:justify-between">
        ...
        <img src="https://pagedone.io/asset/uploads/1710391965.png" alt="" className="mx-auto w-56"/>
